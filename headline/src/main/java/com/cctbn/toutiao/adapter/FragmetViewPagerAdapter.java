 ...
 */
public class FragmetViewPagerAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener{
    ...
    private final String[] TITLES = { "全部", "视频", "公路", "海运", "铁路", "航空",
            "货运" };

    public FragmetViewPagerAdapter(FragmentManager fragmentManager, ViewPager viewPager, List<Fragment> fragments) {
